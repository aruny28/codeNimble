...
public class EspressoTests {
    ...
    public void test_shop() throws Exception {
        ...
        Thread.sleep(5000);
        UiObject pmppage = mDevice.findObject(new UiSelector().text("girls 7 16 in Tops"));
        //
        ...
        UiObject cp = mDevice.findObject(new UiSelector().resourceId(APP_PACKAGE + ":id/id_productMatirx_header_count"));
        ...
        Thread.sleep(20000);
        onWebView().withElement(findElement(Locator.ID, "objLink_orderSummaryFooterButton")).perform(DriverAtoms.webClick());
        //Thread.sleep(7500);
        //onWebView().withElement(findElement(Locator.ID, "objLink_delivery_Pickup")).perform(DriverAtoms.webClick());
        //Thread.sleep(7500);
        //onWebView().withElement(findElement(Locator.ID, "objLink_orderSummaryFooterButton")).perform(DriverAtoms.webClick());
        //Thread.sleep(7500);
        //onWebView().withElement(findElement(Locator.ID, "objLink_orderSummaryFooterButton")).perform(DriverAtoms.webClick());
        Thread.sleep(10000);
        UiObject web = mDevice.findObject(new UiSelector().className(android.webkit.WebView.class.getName()));
        Log.i("NimbleDroidV1", "Scenario.begin load_checkout");
        onWebView().withElement(findElement(Locator.ID, "objLink_orderSummaryFooterButton")).perform(DriverAtoms.webClick());
        Thread.sleep(1000);
        assert_element(mDevice.findObject(new UiSelector().text("Order Confirmation")), 10000);
        Log.i("NimbleDroidV1", "Scenario.end load_checkout");
